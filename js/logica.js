...
function inicio(){
    ...
    document.getElementById("cifrar").addEventListener("click",function(){  
        ...
        document.getElementById("txt2").value = cifrar2(texto, desplazamiento);
    },true);
    document.getElementById("descifrar").addEventListener("click",function(){  
        let texto = document.getElementById("txt").value;
        let desplazamiento = document.getElementById("desplazamiento").value;                               
        document.getElementById("txt2").value = descifrar(texto, desplazamiento);
    },true);
}
...
function cifrar(texto, desplazamiento) {
    ...
    return texto.replace(/[ABCDEFGHIJKLMNÑOPQRSTUVWXYZ]/ig, c => letras[(letras.indexOf(c) + desplazamiento) % 27]);
    if (texto=="1234567890")
        return "NO PONGAS NUMEROS";
}
